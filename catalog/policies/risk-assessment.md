...
{{organization}} reviews risks on a regular basis, to ensure proper mitigations are in place.

### Scope

This policy covers any risk that could affect confidentiality, availability, and integrity of {{organization}}’s key information assets and systems.
...
{{organization}}’s Security team is responsible for reviewing risks on an annual basis.
