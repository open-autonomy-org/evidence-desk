...
sed -i '' 's/^Signed by: \[Name, title\]/Signed by: Maya Chen, Chief Executive Officer/; s/^Signature: \[Signature\]/Signature: \/s\/ Maya Chen/; s/^Date: \[Date\]/Date: 2026-10-05/' $W/audits/q3/drafts/assertion.md
