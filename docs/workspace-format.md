...
title, description and controls it was decided on, and a vendor review's covers its recorded assurance: rewriting
those after signing asks for the signature again, while a re-score, a new owner or a new date does not. Where the repository carries the
